    ...
    <div className="p-6 md:p-8 max-w-3xl mx-auto space-y-6">
      ...
      <Card>
        <CardContent className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5"><Label>Email</Label><Input type="email" value={form.email} disabled className="bg-muted" /></div>
          ...
          <div className="pt-3 border-t border-border space-y-3">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Next of Kin</h3>
            <div className="grid grid-cols-2 gap-3">
